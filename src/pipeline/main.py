...
src_pts = np.float32([[340, 336], [192, 327], [405, 286], [289, 264]])  

# Now write real points in meters 
dst_pts = np.float32([[0, 0], [0, 3.5], [3, 0], [3, 3.5]])  

# Transformation Matrix
M = cv2.getPerspectiveTransform(src_pts, dst_pts)

video_path = r"C:\Todos mis documentos\vehicle-intelligent-traffic\data\bridge\bridge_crash.mp4" # Video
...
# video analyzed
output_video_path= os.path.join(base_path,"data","output_data","video_analyzed.avi")
